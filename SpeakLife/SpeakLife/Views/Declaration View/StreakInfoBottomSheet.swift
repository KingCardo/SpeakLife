...
struct StreakInfoBottomSheet: View {
    ...
    var body: some View {
        VStack {
            ...
            Text("Practice speaking life, meditating, using your imagination for 10 minutes a day to build a habit. Preferably free of distractions. It will significantly improve your life!")
                .lineLimit(nil)
