   ...
   // Renew your mind thru right believing
    ...
    let features: [Feature] = [
       // Feature(name:  appState.subscriptionTestnineteen ? "3 days free, then" : "7 days free, then", subtitle: "Cancel anytime before trial ends."/* Start declaring your blessings today!**Declare and manifest a long, prosperous, peaceful life for you and your family."*/, isAvailableInFree: false, isAvailableInPro: true),
        ...
        Feature(name: "3000+ library of affirmations", subtitle: "Declare and activate a life of prosperity, peace, and health for yourself and your loved ones."/* Start declaring your blessings today!**Declare and manifest a long, prosperous, peaceful life for you and your family."*/, isAvailableInFree: false, isAvailableInPro: true),
        Feature(name: "365+ Daily devotional's", subtitle: "Receive Jesus' grace and love for you and be victorious."/*Receive Jesus's love and be victorious from guilt, anxiety, and fear."*/, isAvailableInFree: false, isAvailableInPro: true),
