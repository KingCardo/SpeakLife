...
//  SpeakLife
//
//  Created by Riccardo Washington on 12/27/24.
//
...
// SpeakLife files
let growWithJesusFiles: [AudioDeclaration] = [
    AudioDeclaration(
        id: "growJesus-ep1.mp3",
        title: "Jesus Wants You Close",
        subtitle: "Episode 1",
        duration: "3m",
    ...
    AudioDeclaration(
        id: "growJesus-ep2.mp3",
        title: "Friendship with God Is Real",
        subtitle: "Episode 2",
        duration: "3m",
        imageUrl: "growWithJesus",
        isPremium: true
    ...
    AudioDeclaration(
        id: "growJesus-ep3.mp3",
        title: "He’s Not a Religion—He’s a Person",
        subtitle: "Episode 3",
        duration: "3m",
        imageUrl: "growWithJesus",
        isPremium: true
    ...
    AudioDeclaration(
        id: "growJesus-ep4.mp3",
        title: "You Don’t Have to Perform, Just Be Present",
        subtitle: "Episode 4",
        duration: "3m",
        imageUrl: "growWithJesus",
        isPremium: true
    ...
    AudioDeclaration(
        id: "growJesus-ep7.mp3",
        title: "Walking Means Trusting",
        subtitle: "Episode 7",
        duration: "3m",
        imageUrl: "growWithJesus",
        isPremium: true
    ...
    AudioDeclaration(
        id: "growJesus-ep8.mp3",
        title: "He’s In Your Ordinary Moments",
        subtitle: "Episode 8",
        duration: "3m",
        imageUrl: "growWithJesus",
        isPremium: true
    ...
    AudioDeclaration(
        id: "growJesus-ep9.mp3",
        title: "You Don’t Have to Feel It to Be Close",
        subtitle: "Episode 9",
        duration: "3m",
        imageUrl: "growWithJesus",
        isPremium: true
    ...
    AudioDeclaration(
        id: "growJesus-ep10.mp3",
        title: "Walking Means Letting Him Lead",
        subtitle: "Episode 10",
        duration: "3m",
        imageUrl: "growWithJesus",
        isPremium: true
    ...
    AudioDeclaration(
        id: "growJesus-ep12.mp3",
        title: "He’s Still With You When You’re Struggling",
        subtitle: "Episode 12",
        duration: "3m",
        imageUrl: "growWithJesus",
        isPremium: true
    ...
    AudioDeclaration(
        id: "growJesus-ep13.mp3",
        title: "Doubt Doesn’t Disqualify the Relationship",
        subtitle: "Episode 13",
        duration: "3m",
        imageUrl: "growWithJesus",
        isPremium: true
    ...
    AudioDeclaration(
        id: "growJesus-ep14.mp3",
        title: "When You Don’t Feel Worthy to Be Close",
        subtitle: "Episode 14",
        duration: "3m",
        imageUrl: "growWithJesus",
        isPremium: true
